...
const ContactDetails = ({ show, onHide }) => {
  return (
    <Modal
      ...
      centered
      size="xl"
      dialogClassName="contact-detail-modal"
    >
        ...
        <header className="contact-header">
          ...
          <div className="contact-options-wrap">
            ...
            <Dropdown className="mx-3  d-xl-block d-none">
              <Dropdown.Toggle variant="light" type="button">
                Action
              </Dropdown.Toggle>
              <Dropdown.Menu>
            ...
            <div className="align-items-center d-xl-flex d-none">
              1 - 10 of 30
            </div>
            <Link
              to="#"
              className="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover contactapp-info-toggle  d-xl-inline-block d-none"
                  ...
                  <Card.Body>
                    <ul className="hk-list hk-list-sm">
                      <li>
                        <Button
                          variant="primary"
                          className="btn-icon btn-rounded btn-primary"
                        >
                          <span className="icon">
