...
const ChatBotInterface = ({ show, sendMsg, msg }) => {
  ...
  return (
    <>
      <div
        className={classNames("hk-chatbot-popup", {
      ...
      >
        ...
        <div className={classNames("chatbot-popup-body")}>
          <SimpleBar
            className={classNames("nicescroll-bar", {
              "mt-0": startConversation,
            })}
          >
            <div>
              <div
                className={classNames("init-content-wrap", {
              ...
              >
                <Card className="card-shadow">
                  <Card.Body>
                    ...
                    <Button
                      variant="primary"
                      className="btn-block text-nonecase start-conversation"
                ...
                <div className="btn-wrap">
                  <Button
                    ...
                    className="text-nonecase btn-rounded start-conversation"
                    onClick={() => setStartConversation(!startConversation)}
                  >
                    <span>
                      <span className="icon">
        ...
        <footer>
          <div
            className={classNames("chatbot-intro-text fs-7", {
              "d-none": startConversation,
            })}
          >
            ...
            <a className="d-block mb-2" href="#some">
              <u>Give Feedback</u>
            </a>
          </div>
          <InputGroup className={classNames({ "d-none": !startConversation })}>
            <div className="input-group-text overflow-show border-0">
              <Dropdown>
                <Dropdown.Toggle
                  variant="flush-dark"
                  className="btn-icon flush-soft-hover btn-rounded no-caret"
                >
                  <span className="icon">
                    <span className="feather-icon">
                      <Icons.Share />
            ...
            <div className="input-group-text overflow-show border-0">
              <Button
                variant="flush-dark"
                className="btn-icon flush-soft-hover btn-rounded"
              >
                <span className="icon">
                  <span className="feather-icon">
                    <Icons.Smile />
      ...
      <Button
        variant="primary"
        size="lg"
        className="btn-icon btn-floating btn-rounded btn-popup-open"
        onClick={() => {
      ...
      <div
        className={classNames("chat-popover shadow-xl", {
          "d-flex": showPopup,
        })}
      >
