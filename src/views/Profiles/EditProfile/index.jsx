            ...
            <Col lg={10} sm={9} xs={8}>
              <Tab.Content>
                    ...
                    <Row className="gx-3">
                      <Col sm={12}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            type="text"
                            defaultValue="Lane no 1, Newyork"
                          />
                        </Form.Group>
                      </Col>
                    </Row>
                    <Row className="gx-3">
                      <Col sm={12}>
                        <Form.Group className="mb-3">
                          ...
                          />
                          <Form.Text muted>
                            Brief bio about yourself. This will be displayed on
                            your profile page.
                          </Form.Text>
                        </Form.Group>
                      </Col>
                ...
                <Tab.Pane eventKey="tabBlock2">
                  ...
                  <p className="mb-4">
                    The Avatar component is used to represent a user, and
                    displays the profile picture, initials or fallback icon.
                  </p>
                  <Form>
                    <Row className="gx-3">
                      <Col sm={12}>
                    ...
                    <Row className="gx-3">
                      <Col sm={12}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            type="text"
                            defaultValue="UA-1387652-1"
                          />
                          <Form.Text muted>
                            Track shot and profile views in your Google
                            analytics account, eg. UA-0000000-0
                          </Form.Text>
                        </Form.Group>
                      </Col>
                    </Row>
                    ...
                    <Row className="gx-3">
                      <Col sm={12}>
                        <Form.Check className="form-check-lg">
                          ...
                          <Form.Check.Label htmlFor="customChecks1">
                        ...
                        <Form.Check className="form-check-lg">
                          ...
                          <Form.Check.Label htmlFor="customChecks2">
                            Keep my phone number private
                          </Form.Check.Label>
                          <Form.Text muted className="d-block">
                            No one can find you by your phone number. Your phone
                            number will not be shared with your contact anymore.
                          </Form.Text>
                        </Form.Check>
                        <div className="separator" />
                        <Form.Check className="form-check-lg">
                          <Form.Check.Input id="customChecks3" />
                          <Form.Check.Label htmlFor="customChecks3">
                        ...
                        <Form.Check className="form-check-lg">
                          ...
                          <Form.Check.Label htmlFor="customChecks4">
                            Share data through select partnerships
                          </Form.Check.Label>
                          <Form.Text muted className="d-block">
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit. Pellentesque condimentum mauris volutpat enim
                            ornare iaculis. Curabitur euismod rutrum lorem id
                            lobortis. Cras ut ex dui. Nulla sed blandit tortor.
                            In quam diam, efficitur sit amet pulvinar eget,
                    ...
                    <Row className="gx-3">
                      <Col sm={12}>
                        <Form.Group>
                          ...
                          <Form.Text muted className="d-block">
                            2-step verification drastically reduces the chances
                            of having the personal information in your Google
                            account stolen by someone else. Why? Because hackers
                            would have to not only get your password and your
                            username, they'd have to get a hold of your phone. A{" "}
                            <a href="#some" className="text-primary">
                              6-digit
                            </a>{" "}
                            code may be sent to a number you’ve previously
                            provided. Codes can be sent in a text message (SMS)
                            or through a voice call, which depends on the
                            setting you chose. To verify it’s you, enter the
