        ...
        <li className="media received">
          <div className="avatar avatar-xs avatar-rounded">
            ...
            {typeof avatar === "object" && (
              <div
                className={`avatar avatar-${avatar.variant} avatar-rounded avatar-xs`}
              >
        ...
        <li className="media sent">
          <div className="media-body">
            <div className="msg-box">
              <div>
                <p>
                  Haha, this joke is hilarious. Is it what your heart feel about
                  the salary? 😍
                </p>
                <span className="chat-time">10:52 PM</span>
              </div>
          ...
          <li className={classNames("media", elem.types)} key={index}>
            {elem.types === "received" && (
              <div className="avatar avatar-xs avatar-rounded">
                ...
                {typeof avatar === "object" && (
                  <div
                    className={`avatar avatar-xs avatar-${avatar.variant} avatar-rounded`}
                  >
                    <span className="initial-wrap">{avatar.title}</span>
                  </div>
                )}
