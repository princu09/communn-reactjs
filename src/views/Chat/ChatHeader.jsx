    ...
    <>
      <header className="chat-header">
        <Button
          ...
          variant="flush-dark"
          size="sm"
          className="btn-icon btn-rounded flush-soft-hover back-user-list"
          ...
          <div className="media">
            <div className="media-head">
              <div className="avatar avatar-sm avatar-rounded position-relative">
                {typeof currentChat.image === "string" && (
                  <img
                ...
                <div className="badge-icon badge-circle badge-icon-xxs text-white position-bottom-end-overflow-1">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 141 141">
                    <g transform="translate(-79 -975)">
                      <path
                        d="M70.5,0A70.5,70.5,0,1,1,0,70.5,70.5,70.5,0,0,1,70.5,0Z"
                        transform="translate(79 975)"
                        fill="#fff"
                      />
                      <path
                        d="M55.5,0A55.5,55.5,0,1,1,0,55.5,55.5,55.5,0,0,1,55.5,0Z"
                        transform="translate(94 990)"
                        fill="#fff"
                      />
                    </g>
                  </svg>
        ...
        <div className="chat-options-wrap">
          {/* <Button
            as="a"
            variant="flush-dark"
            className="btn-icon btn-rounded flush-soft-hover d-none d-xl-block"
          ...
          <Button
            ...
            className={classNames(
              "btn-icon btn-rounded flush-soft-hover chatapp-info-toggle",
              { active: infoState }
            )}
            onClick={infoToggle}
          >
          ...
          <Dropdown className="inline-block ms-1">
            <Dropdown.Toggle
              as="a"
              className="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover no-caret"
              href="#"
            >
              <HkTooltip
                placement={topNavCollapsed ? "bottom" : "top"}
